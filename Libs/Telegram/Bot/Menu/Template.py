    ...
    def main_menu_keyboard(match: Match):
        ...
        if match.instagram:
            ...
            if len(instagrams) == 1:
                ...
                keyboard.append([InlineKeyboardButton(f'iG: {instagrams[0]["login"]} ({open_instagram})', callback_data=f'instagram/{match.match_id}/0')])
                ...
                keyboard.append([InlineKeyboardButton(f'ig: {instagrams[1]["login"]} ({open_instagram})', callback_data=f'instagram/{match.match_id}/1')])
                keyboard.append(
                    [
